    ...
    <div className="page">
      ...
      <div className="header">
        <div>
          ...
          <p>
            Descarga la plantilla, completa tu Excel/CSV y súbelo aquí. Verás un preview con validación antes de guardar en{' '}
            <code>cliente_inventario</code>.
          </p>
        </div>
